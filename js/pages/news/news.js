import { news } from "./components/newsList.min.js";
console.log("hi");
var newBox = document.querySelector(".news-list_list");
...
function openNew(event) {
    ...
    var element = event.target.closest(".news-list_list_item");
...
document.querySelector(".news-modal_body_clouse").addEventListener("click", clouseModal);
